  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col lg:flex-row">
      ...
      <header className="lg:hidden sticky top-0 z-40 flex items-center gap-3 px-4 h-14 bg-card border-b border-rule">
        ...
        <span className="ml-auto text-[9px] uppercase tracking-wider font-bold bg-ink text-paper px-1.5 py-0.5 rounded">
          Admin
        </span>
      </header>
      ...
      <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-card border-r border-rule sticky top-0 h-screen">
        <Link
          to="/"
          className="flex items-center px-5 h-16 border-b border-rule"
        >
          <SiteLogoMark size={22} />
          <span className="ml-auto text-[9px] uppercase tracking-wider font-bold bg-ink text-paper dark:bg-surface dark:text-ink px-1.5 py-0.5 rounded">
            Admin
          </span>
        </Link>
        <AdminModerationAlert />
