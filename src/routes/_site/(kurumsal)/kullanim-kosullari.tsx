...
const SECTIONS: { h: string; p: string }[] = [
  ...
  {
    h: "7. Сигнали за незаконно съдържание и възражения",
    p: `Всеки може да подаде сигнал за съдържание чрез бутона „Докладвай" или на ${SITE_CONTACT_EMAIL}. Сигналът следва да посочва конкретната публикация и причината. Разглеждаме сигналите без необосновано забавяне.`,
  },
  {
    h: "8. Мотивирано решение и обжалване",
    p: "Когато ограничим, скрием или премахнем публикация, уведомяваме автора с мотиви за решението и посочваме на какво основание е взето. Авторът и подателят на сигнала могат да възразят срещу решението на посочения по-горе контакт; възражението се преразглежда от лице, което не е взело първоначалното решение.",
  },
  {
    h: "9. Права на марките",
    p: "Марка, засегната от публикация, може да поиска коригиране на фактически неточности или премахване на незаконно съдържание по същия ред. Публикуването на официален отговор е безплатно и не зависи от абонамент.",
  },
  {
    h: "10. Промени",
